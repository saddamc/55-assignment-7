        ...
        <Form
            ...
            <div>
                ...
                <textarea  id="content" name="content" rows={4}
                    className="w-full rounded-md border px-3 py-2 focus:ring focus:ring-blue-500"
                />
            </div>
            ...
            <button
                type="submit"
                className="w-full bg-blue-600 text-white font-medium rounded-md hover:ring-blue-700 transition"
            >
                Submit
            </button>
